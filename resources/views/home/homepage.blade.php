...
<head>  
    ...
    <title> clayrocktrustbank.com </title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <a class="navbar-brand style3" href="index-2.html">
...
<span class="toggler-icon"></span>
   <span class="toggler-icon"></span>
    ...
    <li class="nav-item">
    <a href="projects.html" aria-label="Toggle navigation">Projects</a>
                                    </li>
                                    </li>
        <li class="nav-item">
        <a href="service-details.html" aria-label="Toggle navigation">Services</a>
                                    </li>
                                    </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
        <a href="about.html" aria-label="Toggle navigation">About Us</a>
                                    </li>
        ...
        <a href="account/index.html" class="btn">Signup </a>
                            </div>
                        </nav>
                        <!-- End Navbar -->
                    </div>
    ...
    <font color="white">
  clayrocktrustbank</font>
    <font color="red"> SAVINGS BANK</font>
    </h2>
    <h3 class="wow fadeInLeft" data-wow-delay=".9s">Your Banking and Financial Solution</h3>
    <div class="hero-btn mt-40">
    <a class="btn btn-one wow fadeInLeft" data-wow-delay="1.2s" href="account/index.html">
    Account Login
...
a Daily Expenses</h2>
<p class="card-text">At the nexowealthfinance, we believe that your bank should support your dreams and aspirations. That’s why we have developed convenient mortgage solutions to help make your dream of owning your own business a reality...</p>
<p>Whether you are a first time investor, or thinking about property purchase as an investment, we have convenient mortgage solutions for you.</p>
                            </div>
<div class="row g-0">
...
<h5>we are trusted by more than 25,800 clients</h5>
    ...
    <p>This is available for customers interested in buying houses with any of the Bank’s accredited property.</p>
    <div class="service-shape">
    <img src="images/service/shape.png" alt="shape">
                                        </div>
                                    </div>
...
<p>This loans are available to our customers who wish to establish large scale business which demands high capital.</p>
    <div class="service-shape">
    <img src="images/service/shape.png" alt="shape">
                                        </div>
                                    </div>
    ...
    <p>Whether for a new car, truck or boat or for your dream house,Wendergroupe BANK  will be there to guide you through.</p>
    <div class="service-shape">
    <img src="images/service/shape.png" alt="shape">
                                        </div>
                                    </div>
    ...
    <p>For those who have strong will for man-power development or want to further their education, we have got you covered.</p>
    <div class="service-shape">
    <img src="images/service/shape.png" alt="shape">
                                        </div>
                                    </div>
    ...
    <p>This loans are available for those wants to go into real estate building and management investmest, with minimal interest.</p>
    <div class="service-shape">
    <img src="images/service/shape.png" alt="shape">
                                        </div>
                                    </div>
    ...
    <p>About 25 gold mining companies are partnering with us for loans, which they invest across the globe for equipment purchase.</p>
    <div class="service-shape">
    <img src="images/service/shape.png" alt="shape">
                                        </div>
                                    </div>
    ...
    <p>Do you have a dream of becoming a land owner? Our bank has got your covered with world's most attractive offer.</p>
    <div class="service-shape">
     <img src="images/service/shape.png" alt="shape">
                                        </div>
                                    </div>
...
<p>Happy Clients</p>
    ...
    <section id="project-section" class="mt-110">
        ...
        <p class="wow fadeInLeft" data-wow-delay=".4s">Create new products, reduce cost and risk, and enable the manufacturing. Innovations enabled by the nexowealthfinance and afiliate institutes results in products that assist workers.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="testimonial-text">
<p>This is a great financial industry. it's financial market work best because they are competitive, 
...
<li><a href="javascript:void(0)">Apply Online</a></li>
    ...
    <div class="copyright text-center mt-50">
        ...
        <div class="row">
        <div class="col-12">
        <p class="copyright-text mb-0">All Rights Reserved 2022 <a href="javascript:void(0)/" rel="nofollow">clayrocktrust@gmail.com</a>
                    </p>
                </div>
            </div>
        </div>
