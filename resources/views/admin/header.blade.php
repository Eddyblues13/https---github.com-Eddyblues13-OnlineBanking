...
<head>
    ...
    <title>Fundformeprogram | User Dashboard</title>
    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <!--            <li>-->
                <!--                <a href="https://altruisticmarkets.com/account/admin/dashboard/addmanager">-->
                <!--                    <span class="sub-item">Add Manager</span>-->
                <!--                </a>-->
                <!--            </li>-->
                <!--            <li>-->
                <!--                <a href="https://altruisticmarkets.com/account/admin/dashboard/madmin">-->
